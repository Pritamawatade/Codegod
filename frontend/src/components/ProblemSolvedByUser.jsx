  ...
  return (
    <div className="p-4 bg-white w-full  dark:bg-[#0c0d0e] border border-[#cabfbf] dark:border-[#3a3a40] ">
      <div className="max-w-4xl mx-auto">
        <h2 className="text-2xl font-bold text-black dark:text-white mb-6">Problems Solved</h2>
          ...
          <div className="card bg-base-100 shadow-xl overflow-hidden">
            <div className="overflow-x-auto">
              <table className="table table-zebra w-full bg-gray-100 dark:bg-[#0b1018]">
                <thead>
                  <tr>
                    <th className="bg-gray-100 border-gray-300 dark:bg-[#0b1018] dark:text-white text-black border dark:border[#3a3a40]">Problem</th>
                    <th className="bg-gray-100 border-gray-300 dark:bg-[#0b1018] dark:text-white text-black border dark:border[#3a3a40]">Difficulty</th>
                    <th className="bg-gray-100 border-gray-300 dark:bg-[#0b1018] dark:text-white text-black border dark:border[#3a3a40]">Tags</th>
                    <th className="bg-gray-100 border-gray-300 dark:bg-[#0b1018] dark:text-white text-black border dark:border[#3a3a40] text-center">Actions</th>
                  </tr>
                </thead>
                <tbody>
            ...
            <div className="card-footer bg-gray-100 dark:bg-[#0b1018] p-4">
              <div className="flex justify-between items-center">
                ...
                <Link to="/problems" className="btn btn-sm btn-primary dark:btn-outline">
                  Solve more problems
                </Link>
              </div>
            </div>
        ...
        {solvedProblems.length > 0 && (
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mt-6">
            <div className="stat bg-gray-100 dark:bg-[#0b1018] shadow rounded-box border dark:border-[#3a3a40]">
              <div className="stat-title text-gray-900 dark:text-white">Easy</div>
              <div className="stat-value text-success">
                {solvedProblems.filter(p => p.difficulty === 'EASY').length}
              </div>
            </div>
            <div className="stat bg-gray-100 dark:bg-[#0b1018] shadow rounded-box border dark:border-[#3a3a40]">
              <div className="stat-title text-gray-900 dark:text-white">Medium</div>
              <div className="stat-value text-warning">
                {solvedProblems.filter(p => p.difficulty === 'MEDIUM').length}
              </div>
            </div>
            <div className="stat bg-gray-100 dark:bg-[#0b1018] shadow rounded-box border dark:border-[#3a3a40]">
              <div className="stat-title text-gray-900 dark:text-white">Hard</div>
