    ...
    <div className="space-y-4 text-sm">
      {submissions.map((submission) => {
        ...
        return (
          <div
            key={submission.id}
            className="card bg-base-200 dark:bg-gray-800 shadow-lg hover:shadow-xl transition-shadow rounded-lg"
          >
            <div className="card-body p-4">
              <div className="flex items-center justify-between">
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div className="badge badge-neutral dark:badge-neutral">
                    {submission.language}
                  </div>
                </div>

                {/* Right Section: Runtime, Memory, and Date */}
                <div className="flex items-center gap-4 text-base-content/70 dark:text-base-content/70">
